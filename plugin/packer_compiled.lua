...
_G.packer_plugins = {
  ...
  ["aquarium-vim"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/aquarium-vim",
  ...
  ["vim-ReplaceWithRegister"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/vim-ReplaceWithRegister",
    url = "https://github.com/inkarkat/vim-ReplaceWithRegister"
  },
  ["vim-maximizer"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/vim-maximizer",
    url = "https://github.com/szw/vim-maximizer"
  },
  ["vim-nightfly-guicolors"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/vim-nightfly-guicolors",
